...
```{r, fig.align='center', comment=">", fig.cap = 'Annual maximum sea levels at Port Pirie, South Australia.', cache=TRUE}
data("portpirie")
...
```{r, fig.align='center', comment=">", fig.cap = 'Danish reinsurance claim data.', cache=TRUE}
par(mfrow=c(1,3))
data("danishuni")
