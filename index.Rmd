...
install.packages(c("wavethresh", "splines2", "astsa", "xts", "quantspec", "TSA", "kza", "itsmr", "dismo", "waveslim", "geoR", "SpatialEpi", "spBayes", "fields", "RandomFields", "SpatialExtremes", "spatstat", "ggplot2", "splancs", "evd", "plotrix", "geoRglm"))
