...
```{r, fig.align='center', comment=">", fig.cap = 'Plot maximum winter temperature.', cache=TRUE}
...
```{r, fig.align='center', comment=">", fig.cap = 'Fit a GEV distribution.', cache=TRUE}
...
```{r, fig.align='center', comment=">", fig.cap = 'Fit a GEV distribution with AOindex.', cache=TRUE}
...
```{r, fig.align='center', comment=">", fig.cap = 'Fit a GEV distribution with STDTMAX.', cache=TRUE}
