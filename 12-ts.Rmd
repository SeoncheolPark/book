...
**(week stationary)**  시계열 $x_{t}$가 finite variance를 갖는 process이며
...
**(autocovariance function of a stationary time series)** 정상시계열의 **자기공분산함수(autocovariance function)**는
...
**(autocorrelation function of a stationary time series)** 정상시계열의 **자기상관함수(autocorrelation function)**는
