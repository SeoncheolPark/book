...
```{r, fig.align='center', echo=FALSE, warning=FALSE, message=FALSE, results='hide', fig.cap = 'Smith model.', cache=TRUE}
## 1. Smith's model
set.seed(8)
...
```{r, fig.align='center', echo=FALSE, warning=FALSE, message=FALSE, results='hide', fig.cap = 'Schlather model.', cache=TRUE}
## 2. Schlather's model
