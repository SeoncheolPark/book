...
&=&\sum_{n}h_{n}\phi_{J,n+2k}(x).\label{eq:fatherj2}
\end{eqnarray}

이 때 식 (\@ref(eq:fatherj2))에 (\@ref(eq:fatherj1))을 넣으면
...
```{r, fig.align='center', comment=">", fig.cap = 'acket-ordered non-decimated wavelet coefficients of simulated chirp signal.'}
