...
**결맞음(coherency)** 분석은 두 자료의 관계를 quantify하기 위해 많이들 사용한다. 신호 사이의 결맞음 추정은 중요햐며 대기과학, 통신 및 생명과학 자료에 응용된다.

## 전이함수모형(transfer function model, section 5.7)
...
전이함수의 형태를 식별하기 위해서는 두 개의 시계열 사이의 상관의 정도와 방향을 나타내는 교차상관함수를 이용한다.
